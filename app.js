// ============================================================
// CONFIG — Session D (Set D, Week 4) — paste your NEW Apps Script Web App URL below
// ============================================================
const CONFIG = {
  ENDPOINT_URL: "https://script.google.com/macros/s/AKfycbxkB8SWTteluJveh4Nu-trGBTSzAMuPVm-R8w-WGXBCKn2dq7w8B5GRXuHhDZiDwfT4/exec",
